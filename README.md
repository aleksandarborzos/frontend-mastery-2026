# Path to Frontend Mastery 2026 🚀

An intensive, daily log of my journey from absolute scratch to professional web development.
...
- **01-HTML-CSS-Jonas**: My progress through Jonas Schmedtmann's course.
  ...
  - **02-Project-Practice**: Follow-along code and experiments from the main course projects.
    **Current Focus:** Finishing Omnifood project! 🎯
    echo " " >> README.md
